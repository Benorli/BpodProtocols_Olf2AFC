...
switch Action
    case 'init'
        ...
        BpodSystem.GUIHandles.OutcomePlot.CurrentTrialCross = line(1,0,...
            ...
            [1 1 1],...
            'MarkerSize',6);
        BpodSystem.GUIHandles.OutcomePlot.CumRwdL = text(10,1.2,'Left: 0mL',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
        BpodSystem.GUIHandles.OutcomePlot.CumRwdR = text(10,1.1,'Right: 0mL',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
        BpodSystem.GUIHandles.OutcomePlot.nTrialsL = text(10,1,'nLeft trials',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
        BpodSystem.GUIHandles.OutcomePlot.nTrialsL = text(10,0.9,'nLeft chosen',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
        BpodSystem.GUIHandles.OutcomePlot.nTrialsR = text(10,0.8,'nRight trials',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
        BpodSystem.GUIHandles.OutcomePlot.nTrialsR = text(10,0.7,'nRight chosen',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
    ...
    case 'update'
        ...
        set(BpodSystem.GUIHandles.OutcomePlot.CumRwdL,...
            'position', [iTrial+10 1.2],...
            'string', ['Left:         ' num2str(sum(R(:,1))/1000) ' mL']);
        set(BpodSystem.GUIHandles.OutcomePlot.CumRwdR,...
            'position', [iTrial+10 1.1],...
            'string', ['Right:        ' num2str(sum(R(:,2))/1000) ' mL']);
        set(BpodSystem.GUIHandles.OutcomePlot.nTrialsL,...
            'position', [iTrial+10 1],...
            'string', ['nLeft trials ', num2str(sum(BpodSystem.Data.Custom.MoreLeftClicks(1:iTrial)))]);
        set(BpodSystem.GUIHandles.OutcomePlot.nTrialsL,...
            'position', [iTrial+10 0.9],...
            'string', ['nLeft chosen ', num2str(sum(BpodSystem.Data.Custom.ChoiceLeft))]);
        set(BpodSystem.GUIHandles.OutcomePlot.nTrialsR,...
            'position', [iTrial+10 0.8],...
            'string', ['nRight trials ', num2str(sum(~BpodSystem.Data.Custom.MoreLeftClicks(1:iTrial)))]);
        set(BpodSystem.GUIHandles.OutcomePlot.nTrialsR,...
            'position', [iTrial+10 0.7],...
            'string', ['nRight chosen ', num2str(sum(~BpodSystem.Data.Custom.ChoiceLeft))]);
        % Add n choice, l/r
        clear R C
        %Plot Rewarded
