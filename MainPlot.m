...
switch Action
    case 'init'
        ...
        BpodSystem.GUIHandles.OutcomePlot.CurrentTrialCross = line(1,0,...
            ...
            [1 1 1],...
            'MarkerSize',6);
        BpodSystem.GUIHandles.OutcomePlot.CumRwdL = text(4,1.2,'Left: 0mL',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
        BpodSystem.GUIHandles.OutcomePlot.CumRwdR = text(4,1.1,'Right: 0mL',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
        BpodSystem.GUIHandles.OutcomePlot.nTrialsL = text(4,1,'nLeft trials',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
        BpodSystem.GUIHandles.OutcomePlot.nTrialsR = text(4,0.9,'nRight trials',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
